...
set_property PACKAGE_PIN D5 [get_ports led_wen[1]]
set_property PACKAGE_PIN A3 [get_ports led_wen[0]]
set_property PACKAGE_PIN A5 [get_ports led_addr]
set_property PACKAGE_PIN A4 [get_ports led_wdata]
set_property PACKAGE_PIN F7 [get_ports led_test_addr]
