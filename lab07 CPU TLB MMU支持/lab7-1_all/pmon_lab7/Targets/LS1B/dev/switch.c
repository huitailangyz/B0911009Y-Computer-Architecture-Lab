...
mac_cfg.speed =  getenv("physpeed")?strtoul(getenv("physpeed"),0,0):SPD_100M; 
mac_cfg.duplex = FULL_DUPLEX; 
mac_cfg.link = PORT_LINKUP;
mac_cfg.nway = DISABLED; 
mac_cfg.txpause = ENABLED; 
mac_cfg.rxpause = ENABLED; 
rtk_port_macForceLinkExt0_set(getenv("phytype")?strtoul(getenv("phytype"),0,0):MODE_EXT_MII_PHY,&mac_cfg);
rtk_port_macForceLinkExt1_set(getenv("phytype")?strtoul(getenv("phytype"),0,0):MODE_EXT_MII_PHY,&mac_cfg);
